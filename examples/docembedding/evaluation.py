...
def evalClusteringOnLabels(
    ...
    Algorithm choice:
        ...
        and that is stable across parameter choices. This is for evaluation to be as deterministic as possible.
        ...
        DBSCAN tends to perform poorly on clusters of word embeddings -- it seems they are not clustered by density.

        Agglomerative has an added advantage: on normalized embeddings, the euclidian metric is the same as the 
        well-liked cosine distance (for semantic similarity). Thus agglomerative is our choice.
    """
